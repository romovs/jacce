...
public class TestLRUCache { 
	...
	public void testSimple() throws CacheException {
		test3Objects(initCache("org.jacce.cache.lru.LRUCache", 2, 0));
		test3Objects(initCacheTimed("org.jacce.cache.lru.LRUCacheTimed", 2, 0, 0, 0, 0));
		test3Objects(initCache("org.jacce.cache.lru.ConcurrentLRUCache", 2, 0));
		test3Objects(initCacheTimed("org.jacce.cache.lru.ConcurrentLRUCacheTimed", 2, 0, 0, 0, 0));
	}
	...
	public void testTTL() throws InterruptedException, CacheException {
		testTTL(initCacheTimed("org.jacce.cache.lru.LRUCacheTimed", 2, 0, 0, 10 ,1000*60*60));
		testTTL(initCacheTimed("org.jacce.cache.lru.ConcurrentLRUCacheTimed", 2, 0, 0, 10 ,1000*60*60));
	}
	
	@Test
	public void testIdlePeriod() throws InterruptedException, CacheException {
		testIdle(initCacheTimed("org.jacce.cache.lru.LRUCacheTimed", 2, 0, 0, 0, 10));
		testIdle(initCacheTimed("org.jacce.cache.lru.ConcurrentLRUCacheTimed", 2, 0, 0, 0 ,10));
	}
	...
	public void testInvalidate() throws CacheException, InterruptedException {
		testInv(initCache("org.jacce.cache.lru.LRUCache", 2, 0));
		testInv(initCache("org.jacce.cache.lru.ConcurrentLRUCache", 2, 0));
	}
	
	@Test
	public void testInvalidateGroup() throws CacheException, InterruptedException {
		testInvGroup(initCache("org.jacce.cache.lru.LRUCache", 3, 0));
		testInvGroup(initCache("org.jacce.cache.lru.ConcurrentLRUCache", 3, 0));
	}
