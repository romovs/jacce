...
public class TestFIFOCache { 
	...
	public void testSimple() throws CacheException {
		test3Objects(initCache("org.jacce.cache.fifo.FIFOCache", 2, 0));
		test3Objects(initCacheTimed("org.jacce.cache.fifo.FIFOCacheTimed", 2, 0, 0, 0, 0));
		test3Objects(initCache("org.jacce.cache.fifo.ConcurrentFIFOCache", 2, 0));
		test3Objects(initCacheTimed("org.jacce.cache.fifo.ConcurrentFIFOCacheTimed", 2, 0, 0, 0, 0));
	}
	...
	public void testTTL() throws InterruptedException, CacheException {
		testTTL(initCacheTimed("org.jacce.cache.fifo.FIFOCacheTimed", 2, 0, 0, 10 ,1000*60*60));
		testTTL(initCacheTimed("org.jacce.cache.fifo.ConcurrentFIFOCacheTimed", 2, 0, 0, 10 ,1000*60*60));
	}
	
	@Test
	public void testIdlePeriod() throws InterruptedException, CacheException {
		testIdle(initCacheTimed("org.jacce.cache.fifo.FIFOCacheTimed", 2, 0, 0, 0, 10));
		testIdle(initCacheTimed("org.jacce.cache.fifo.ConcurrentFIFOCacheTimed", 2, 0, 0, 0 ,10));
	}
	...
	public void testInvalidate() throws CacheException, InterruptedException {
		testInv(initCache("org.jacce.cache.fifo.FIFOCache", 2, 0));
		testInv(initCache("org.jacce.cache.fifo.ConcurrentFIFOCache", 2, 0));
	}
	
	@Test
	public void testInvalidateGroup() throws CacheException, InterruptedException {
		testInvGroup(initCache("org.jacce.cache.fifo.FIFOCache", 3, 0));
		testInvGroup(initCache("org.jacce.cache.fifo.ConcurrentFIFOCache", 3, 0));
	}
