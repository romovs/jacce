 ...
 */
public class CARCache extends Cache {
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(CARCache.class.getName());
	...
	public CARCache(String id, String description, int capacity, int memorySize) {
