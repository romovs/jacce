 ...
 * 
 * The <code>clean</code> routine is synchronized with <code>get</code> and <code>set</code> and
 * also very computationally expensive. Usage of <code>clean-interval</code> with this implementation
 * should be avoided.
 * 
 * TODO: constant size buffer for t1,t2,b1,b2
 */
public class ConcurrentCARCacheTimed extends CacheTimed {

	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(ConcurrentCARCacheTimed.class.getName());
	...
	public ConcurrentCARCacheTimed(String id, String description, int capacity, int memorySize,
	...
	public Object get(Object id) {
		...
		synchronized (this) {				// need to synchronize this in case we need to evict expired entry
			CARItemTimed ci = t1map.get(id);
